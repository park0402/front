...
<body>
	...
	<div class="container">
		...
		<h3> 글쓰기 </h3>
		<form action="../board/bupdate?bno=<%=board1.getBno1() %>" method="post" enctype="multipart/form-data" >
			<!-- form 전송 인코딩 타입 : 기본타입은 첨부파일 불가능  -->
			<!-- form 첨부파일 전송 인코딩 타입 : enctype="multipart/form-data" -->
			제목 : <input type="text" name="btitle1" value="<%=board1.getBtitle1()%>"> <br>
			<textarea name="bcontent1" id="summernote" value="<%=board1.getBcontent1()%>"></textarea>
			첨부파일 : <input type="file" name="bfile1"> <br>
