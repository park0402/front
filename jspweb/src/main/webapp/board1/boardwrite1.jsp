...
<body>
	...
	<div class="container">
		<a href="boardlist1.jsp"><button>글목록</button></a>
		<h3> 글쓰기 </h3>
		<form action="../board1/write1" method="post" enctype="multipart/form-data" >
			<!-- form 전송 인코딩 타입 : 기본타입은 첨부파일 불가능  -->
			<!-- form 첨부파일 전송 인코딩 타입 : enctype="multipart/form-data" -->
			제목 : <input type="text" name="btitle1"> <br>
			<textarea name="bcontent1" id="summernote"></textarea>
